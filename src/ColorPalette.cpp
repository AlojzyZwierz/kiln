...
void buildCustomPalette()
{
    ...
    uiPalette[COLOR_RED_DOT]      = TFT_eSPI().color565(180, 50, 60);
    uiPalette[COLOR_BG]           = TFT_eSPI().color565(250, 248, 245);     // lekko kremowy
    uiPalette[COLOR_BUTTON]       = TFT_eSPI().color565(200, 185, 175);     // mocniejszy od tła
